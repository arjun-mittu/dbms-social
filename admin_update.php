...
<table style = 'margin-top: 50px' class='table table-dark' id = 'table1' style = 'border-radius: 10px'>
...
<div class="input-group input-group-lg" style = "margin-top:50px">
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-lg">Column Name</span>
  </div>
  <input type="text" class="form-control" readonly id = 'column' name = "Column_name">
</div>
...
<div class="input-group input-group-lg" style = "margin-top:20px">
  ...
  <input type="text" class="form-control" readonly id = 'id' name = "Channel_Id">
</div>

<div class="input-group input-group-lg" style = "margin-top:20px">
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-lg">Changed Value</span>
  </div>
  <input type="text" class="form-control" name = "Final_Value">
</div>

<input type="submit" class="btn btn-primary" style = "margin-top:20px" value = "Update">
...
<?php	
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$value = $_POST['Final_Value'];	
		include 'connect.php';
		$query = "update subscription set ".$column." ='".$value."' where channel_id = ".$Channel;
...
var table1 = document.getElementById('table1'),rIndex;
for(var i = 0; i<table1.rows.length; i++){
	table1.rows[i].onclick = function(){
		rIndex = this.rowIndex;
		console.log(rIndex);
		document.getElementById("column").value = this.cells[0].innerHTML;
