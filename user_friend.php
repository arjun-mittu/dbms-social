...
<div class="w3-main" style="margin-left:250px">
  ...
  <header class="w3-container w3-xlarge">
	<h1><p class="w3-left" style = "margin: 10px">FRIENDS</p></h1>
  ...
  <?php 
	...
	$query1 = "select photo, user_name from signup, friend where id = friend group by user_id having user_id = ".$row['id'];
	$query1 = mysqli_query($conn,$query1);
	while($row1 = mysqli_fetch_array($query1)){
		echo "<img src = '".$row1['photo']."' width = 125 height = 100>";
		echo "<div class='desc'>";
		echo $row1['user_name'];
		echo '</div>';
	}
