...
<div class="w3-main" style="margin-left:250px">
  ...
  <header class="w3-container w3-xlarge">
	<h1><p class="w3-left" style = "margin: 10px">CHANGE PASSWORD</p></h1>
  ...
  <div class = 'container'>
  <label style = 'margin-top: 10px;'><b>Current Password</b></label><br>
  <input type="password" placeholder = 'Current Password' name = 'old'><br><br>
  <label><b>New Password</b></label><br>
  <input type="password" placeholder = 'New Password' name = 'new'><br>
  ...
  if(isset($_POST['change'])){
	$old = $_POST['old'];
	$new = $_POST['new'];
	$query0 = "select count(*) from signup  where password = '".$old."' and user_name = '".$_SESSION['username']."'";
	$row0 = mysqli_fetch_array(mysqli_query($conn,$query0));
	if($row0['count(*)'] == '1'){
		$query = "update signup set password = '".$new."' where user_name = '".$_SESSION['username']."'";
		$query = mysqli_query($conn,$query);
		if(!$query)
